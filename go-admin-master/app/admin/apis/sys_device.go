...
// @Security Bearer
func (e SysDevice) InsetAvatar(c *gin.Context) {
	s := service.SysDevice{}
	req := dto.UpdateSysDeviceAvatarReq{}
	err := e.MakeContext(c).
		MakeOrm().
		MakeService(&s.Service).
		Errors
...
// @Accept  application/json
// @Product application/json
// @Param data body dto.UpdateSysDeviceStatusReq true "body"
// @Success 200 {object} response.Response "{"code": 200, "data": [...]}"
// @Router /api/v1/user/status [put]
// @Security Bearer
func (e SysDevice) UpdateStatus(c *gin.Context) {
	s := service.SysDevice{}
	req := dto.UpdateSysDeviceStatusReq{}
	err := e.MakeContext(c).
		MakeOrm().
...
// @Accept  application/json
// @Product application/json
// @Param data body dto.ResetSysDevicePwdReq true "body"
// @Success 200 {object} response.Response "{"code": 200, "data": [...]}"
// @Router /api/v1/user/pwd/reset [put]
// @Security Bearer
func (e SysDevice) ResetPwd(c *gin.Context) {
	s := service.SysDevice{}
	req := dto.ResetSysDevicePwdReq{}
	err := e.MakeContext(c).
		MakeOrm().
		Bind(&req, binding.JSON).
		MakeService(&s.Service).
...
// @Security Bearer
func (e SysDevice) UpdatePwd(c *gin.Context) {
	s := service.SysDevice{}
	req := dto.PassWord{}
	err := e.MakeContext(c).
		MakeOrm().
...
// @Security Bearer
func (e SysDevice) GetProfile(c *gin.Context) {
	s := service.SysDevice{}
	req := dto.SysDeviceById{}
	err := e.MakeContext(c).
		MakeOrm().
	...
	SysDevice := models.SysDevice{}
	roles := make([]models.SysRole, 0)
	posts := make([]models.SysPost, 0)
	err = s.GetProfile(&req, &SysDevice, &roles, &posts)
	if err != nil {
...
// @Security Bearer
func (e SysDevice) GetInfo(c *gin.Context) {
	req := dto.SysDeviceById{}
	s := service.SysDevice{}
	r := service.SysRole{}
	err := e.MakeContext(c).
	...
	if SysDevice.Avatar != "" {
		mp["avatar"] = SysDevice.Avatar
	}
	mp["userName"] = SysDevice.Username
	mp["userId"] = SysDevice.UserId
	mp["deptId"] = SysDevice.DeptId
	mp["name"] = SysDevice.NickName
	mp["code"] = 200
	e.OK(mp, "")
}
