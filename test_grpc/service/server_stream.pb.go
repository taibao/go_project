...
var file_server_stream_proto_rawDesc = []byte{
	...
	0x65, 0x61, 0x6d, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x32, 0x50, 0x0a, 0x0c, 0x53, 0x74, 0x72, 0x65,
	0x61, 0x6d, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x12, 0x40, 0x0a, 0x09, 0x4c, 0x69, 0x73, 0x74,
	0x56, 0x61, 0x6c, 0x75, 0x65, 0x12, 0x16, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2e,
...
var file_server_stream_proto_goTypes = []interface{}{
	(*SimpleRequest)(nil),  // 0: service.SimpleRequest
	(*StreamResponse)(nil), // 1: service.StreamResponse
}
var file_server_stream_proto_depIdxs = []int32{
	0, // 0: service.StreamServer.ListValue:input_type -> service.SimpleRequest
	1, // 1: service.StreamServer.ListValue:output_type -> service.StreamResponse
...
func (c *streamServerClient) ListValue(ctx context.Context, in *SimpleRequest, opts ...grpc.CallOption) (StreamServer_ListValueClient, error) {
	stream, err := c.cc.NewStream(ctx, &_StreamServer_serviceDesc.Streams[0], "/service.StreamServer/ListValue", opts...)
	if err != nil {
		return nil, err
	}
...
var _StreamServer_serviceDesc = grpc.ServiceDesc{
	ServiceName: "service.StreamServer",
